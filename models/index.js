...
/**
 * @param  {string} databaseURL - A database connection URL
 * @param  {object} databaseOptions - Options for Sequelize
 * @returns {object} - An object that has attributes related to models (see below)
 */
function load(databaseURL, databaseOptions) {
    ...
    if (databaseURL.startsWith('sqlite')) {
        defaultOptions.storage = url.parse(databaseURL)
            .path;
    }
